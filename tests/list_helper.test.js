...
describe('total likes', () => {
    const listWithBlogs = [
      ...
      test('List with one blog returns that blogs likes', () => {
          const result = listHelper.totalLikes(listWithOneBlog)
          expect(result).toBe(5)
      })

      test('List with multiple blogs returns total like number', () => {
...
describe('favoriteBlog', () => {
    const listWithBlogs = [
      ...
      test('multiple blogs returns correct favorite', () => {
      ...
      test('empty list returns correct', () => {
...
describe('favoriteBlog', () => {
    const listWithBlogs = [
      ...
      test('most blogs returns correct amount on multiple authors', () => {
...
describe('most likes tests', () => {
    ...
    test('most likes returns correct on multiple blogs', () => {
